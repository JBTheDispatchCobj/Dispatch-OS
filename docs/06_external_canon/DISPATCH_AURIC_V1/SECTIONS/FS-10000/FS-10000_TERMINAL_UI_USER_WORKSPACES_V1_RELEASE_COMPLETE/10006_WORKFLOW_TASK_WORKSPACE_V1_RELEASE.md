# 10006 — Workflow & Task Workspace V1

## Purpose

Define the operational surface for executing institutional workflows.
...
- request draft
- request missing-input list
- compare evidence
- create checklist
- rerun allowed step
- escalate

Agent output must show:
...
- Every stage has owner and evidence requirements.
- Agents cannot complete human approval steps.
- Dependencies control task readiness.
- Workflow history is immutable.
- Blockers and SLAs are visible.
...
**Scope:** workflow instances, steps, tasks, dependencies, SLAs, assignments, escalations and compensation.
...
A synthetic executive, operator, analyst, administrator and auditor can complete the principal journeys for Workflow and Task Workspace using the fixture tenant without bypassing evidence, permission or approval controls.
