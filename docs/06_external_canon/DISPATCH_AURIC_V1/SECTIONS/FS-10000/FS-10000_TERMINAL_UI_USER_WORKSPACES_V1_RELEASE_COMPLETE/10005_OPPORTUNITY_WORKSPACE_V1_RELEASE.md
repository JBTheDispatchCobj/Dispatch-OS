# 10005 — Opportunity Workspace V1

## Purpose

Define the workspace for detecting, qualifying, scoring, approving, executing, and measuring opportunities.
...
- User can see why an opportunity was detected.
- Scores and assumptions are explainable.
- Opportunity cannot skip workflow or approval rules.
- Outcome and realized value can be recorded.
- Rejected/deferred opportunities remain auditable.
...
**Scope:** opportunity qualification, scoring, evidence, economics, readiness, routing, approvals and outcomes.
...
A synthetic executive, operator, analyst, administrator and auditor can complete the principal journeys for Opportunity Workspace using the fixture tenant without bypassing evidence, permission or approval controls.
