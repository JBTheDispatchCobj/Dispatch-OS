# 10009 — Dashboard & Reporting Builder V1

## Purpose

Define configurable dashboards and reports built from canonical KPIs, objects, evidence, workflows, and approvals.
...
- XLSX/CSV
- secure link
- board portal package
- evidence binder

## Acceptance Tests

- Every KPI drills to evidence.
- Reports disclose stale or estimated data.
- External reports require approval.
- Locked versions remain reproducible.
- User can save reusable templates.
...
**Scope:** governed metrics, dashboard composition, filters, schedules, exports and report certification.
...
A synthetic executive, operator, analyst, administrator and auditor can complete the principal journeys for Dashboard and Reporting Builder using the fixture tenant without bypassing evidence, permission or approval controls.
