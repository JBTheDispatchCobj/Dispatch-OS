# 10003 — Institution Terminal Workspace V1

## Purpose

Define the complete workspace for one institution.
...
- All institution data is navigable from one workspace.
- Cross-object links preserve context.
- User can identify stale or inferred data.
- Opportunity and workflow actions are available where permitted.
...
**Scope:** institution profile, executives, board, financials, products, vendors, systems, regulation, risk and readiness.
...
A synthetic executive, operator, analyst, administrator and auditor can complete the principal journeys for Institution Terminal Workspace using the fixture tenant without bypassing evidence, permission or approval controls.
