# 10010 — Persona & Role-Based Workspaces V1

## Purpose

Define role-specific workspaces without creating separate products.
...
## External User Workspaces

Startup/vendor/investor users receive:
...
- tasks
- messages
- approvals relevant to them

## Acceptance Tests

- Personas see appropriate complexity.
- Same object has consistent facts across roles.
- External users see only shared scope.
- Role changes update access immediately.
- Board view cannot expose restricted operational detail unless authorized.
...
**Scope:** persona defaults, role entitlements, density modes, queues, delegation and least privilege.
...
A synthetic executive, operator, analyst, administrator and auditor can complete the principal journeys for Persona and Role-Based Workspaces using the fixture tenant without bypassing evidence, permission or approval controls.
