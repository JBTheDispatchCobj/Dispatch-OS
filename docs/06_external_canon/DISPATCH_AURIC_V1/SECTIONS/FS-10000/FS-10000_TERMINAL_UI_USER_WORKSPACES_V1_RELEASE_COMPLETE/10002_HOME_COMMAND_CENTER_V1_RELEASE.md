# 10002 — Home Command Center V1

## Purpose

Define the daily operating home screen for executives, operators, analysts, and administrators.
...
### Data and Evidence Alerts

- stale institution profile
- failed connector
- missing evidence
- conflicting records
- overdue review
- unresolved entity match
...
- overdue funding/settlement condition
...
- User sees only relevant work.
- Critical items remain visible until resolved.
- Every alert has owner and next action.
- Home supports role-specific layouts.
- Personalization does not override governance controls.
...
**Scope:** priorities, alerts, tasks, approvals, active workflows, opportunities, freshness and meetings.
...
A synthetic executive, operator, analyst, administrator and auditor can complete the principal journeys for Home Command Center using the fixture tenant without bypassing evidence, permission or approval controls.
