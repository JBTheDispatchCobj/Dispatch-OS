# 12002 — Identity & Access Management V1

## Purpose

Define identity, authentication, authorization, roles, scopes, access reviews, and offboarding.
...
- external guest
- auditor
- regulator/examiner guest
- vendor/startup guest
...
- Privileged actions are separately logged.
- Offboarding revokes sessions and credentials.
- External guests see only explicitly shared scope.
...
Canonical operations: `POST /v1/security/12002/records`, `GET /v1/security/12002/records/{id}`, `POST /v1/security/12002/records/{id}/submit`, `POST /v1/security/12002/records/{id}/approve`, `POST /v1/security/12002/records/{id}/suspend`, and `POST /v1/security/12002/records/{id}/retire`.

Required events: `12002.record.created`, `12002.record.submitted`, `12002.record.approved`, `12002.control.failed`, `12002.record.suspended`, `12002.exception.opened`, and `12002.record.retired`. Events include event ID, tenant, actor, object version, correlation ID, timestamp, classification, and evidence references.
