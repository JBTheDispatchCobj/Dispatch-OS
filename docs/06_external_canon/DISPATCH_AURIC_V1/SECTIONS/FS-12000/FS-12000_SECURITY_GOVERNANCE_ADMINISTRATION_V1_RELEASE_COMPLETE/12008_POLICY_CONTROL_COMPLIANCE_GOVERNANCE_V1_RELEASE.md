# 12008 — Policy, Control & Compliance Governance V1

## Purpose

Define how governance policies, procedures, controls, obligations, evidence, testing, and approvals are managed.
...
- Policies link to obligations and controls.
- Controls link to evidence.
- Exceptions are time bound.
- Policy approval is auditable.
- Failed controls create issues/remediation.
...
Canonical operations: `POST /v1/security/12008/records`, `GET /v1/security/12008/records/{id}`, `POST /v1/security/12008/records/{id}/submit`, `POST /v1/security/12008/records/{id}/approve`, `POST /v1/security/12008/records/{id}/suspend`, and `POST /v1/security/12008/records/{id}/retire`.

Required events: `12008.record.created`, `12008.record.submitted`, `12008.record.approved`, `12008.control.failed`, `12008.record.suspended`, `12008.exception.opened`, and `12008.record.retired`. Events include event ID, tenant, actor, object version, correlation ID, timestamp, classification, and evidence references.
