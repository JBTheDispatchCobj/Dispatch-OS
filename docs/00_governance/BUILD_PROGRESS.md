...
| Cooperative Markets cartridge (first product; **+ /network surface orchestration**) | 8% | 87% | 6.96 |
| Terminal (customer-facing product; **whole FS-10000 IA framed as 23 surfaces (10 live/13 scaffold) + registry-driven nav + the JOINT /network review-queue surface**) | 7% | 50% | 3.5 |
| Tests / observability / productionization (**UI-SURFACES + NETWORK debug steps; 308 unit tests**) | 5% | 67% | 3.35 |
| **Total** | **100%** | — | **~60%** |
