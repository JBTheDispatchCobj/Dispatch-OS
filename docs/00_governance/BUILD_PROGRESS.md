...
| Kernel services (**identity/permissions**, event bus, object registry, cost ledger, observability, **request envelope + contracts/API**) | 20% | 46% | 9.2 |
...
| Tests / observability / productionization | 5% | 51% | 2.55 |
| **Total** | **100%** | — | **~47%** |
